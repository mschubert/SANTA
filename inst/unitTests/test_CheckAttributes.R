test_CheckAttributes <- function() {
    ...
    checkException(res <- SANTA:::CheckAttributes(g, query.vertex.attr=c("attr1", "attr2")), silent=T)
    ...
    suppressWarnings(suppressMessages(g <- SANTA:::CheckAttributes(g, query.vertex.attr="vertex.attr")))
    ...
    values[1] <- "a"
    g <- set.vertex.attribute(g, name="vertex.attr", value=values)
    checkException(SANTA:::CheckAttributes(g, query.vertex.attr="vertex.attr"), silent=T)
    g <- remove.vertex.attribute(g, "vertex.attr")
    ...
    values[1] <- -1
    g <- set.vertex.attribute(g, name="vertex.attr", value=values)
    checkException(res <- SANTA:::CheckAttributes(g, query.vertex.attr="vertex.attr"), silent=T)
    g <- remove.vertex.attribute(g, "vertex.attr")
    ...
    values <- runif(vcount(g))
    g <- set.vertex.attribute(g, name="vertex.attr", value=values)
    suppressMessages(g <- SANTA:::CheckAttributes(g, query.vertex.attr="vertex.attr", edge.attr="edge.attr"))
    ...
    suppressWarnings(suppressMessages(g <- SANTA:::CheckAttributes(g, query.vertex.attr="vertex.attr", edge.attr="edge.attr")))
    ...
    values[1] <- "a"
    g <- set.edge.attribute(g, name="edge.attr", value=values)
    suppressWarnings(checkException(res <- SANTA:::CheckAttributes(g, query.vertex.attr="vertex.attr", edge.attr="edge.attr"), silent=T))
    g <- remove.edge.attribute(g, "edge.attr")
    ...
    values <- runif(ecount(g))
    g <- set.edge.attribute(g, name="edge.attr", value=values)
    g <- SANTA:::CheckAttributes(g, query.vertex.attr="vertex.attr", edge.attr="edge.attr")
