...
\section{Case study I - Using \Knet to investigate the re-wiring of a cell undergoing DNA damage}
\label{sec:case_1}
...
\section{Case study II - Using \Knode to prioritise genes for follow-up functional studies}
\label{sec:case_2}
